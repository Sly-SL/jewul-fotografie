...
const CommentBody = ({ data }: { data: CommentBodyProps }) => {
    ...
    return (
        <article className="rounded-2xl hover:scale-[1.02] duration-300 bg-white/10 h-full relative border-3 w-full max-w-2xs shadow-2xl border-purple-500/50 p-5 space-y-4">
